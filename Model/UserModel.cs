...
namespace Ecm.Model
{
    ...
    public class UserModel : BaseDependencyProperty, IDataErrorInfo
    {
        ...
        public bool ApplyForCapture
        {
            get { return _applyForCapture; }
            set
            {
                _applyForCapture = value;
                OnPropertyChanged("ApplyForCapture");
            }
        }
        ...
        public string this[string columnName]
        {
            get
            {
                ...
                if (columnName == "Username")
                {
                    ...
                    if (HasError)
                    {
                        msg = string.IsNullOrWhiteSpace(Username) ? Resources.uiUserNameEmpty : Resources.uiUsernameExisted;
                    }
                }
