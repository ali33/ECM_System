...
namespace OutlookCapture
{
    ...
    public class Ribbon : Office.IRibbonExtensibility
    {
        ...
        public Action LogoutClick { get; set; }
        public Action<object> SendToCaptureClick { get; set; }

        #region IRibbonExtensibility Members

        public string GetCustomUI(string ribbonID)
        {
            return GetResourceText("OutlookCapture.Ribbon.xml");
        }
        ...
        {
            if (SendToCaptureClick != null)
            {
                SendToCaptureClick(control);
            }
        }
