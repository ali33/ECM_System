...
namespace Ecm.Context
{
    public class DapperContext : IDisposable
    {
        ...
        {
            _connectionString = ConfigurationManager.ConnectionStrings["ECMConnectionString"].ConnectionString;
            ...
            _connectionString = ConnectionStringEncryptionHelper.GetDecryptpedConnectionString(_connectionString, ENCRYPTED_KEY);
