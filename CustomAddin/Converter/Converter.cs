...
namespace Ecm.CustomAddin.Converter
{
    ...
    public class ThumbnailConverter : IValueConverter
    {
        public object Convert(object value, Type targerType, object parameter, CultureInfo culture)
        {
            if (value == null)
            {
                return new Uri("pack://application:,,,/Ecm.CustomAddin;component/Resources/Images/unknow.gif");
            }
            ...
            switch (fileExtension)
            {
                case "xls":
                case "xlsx":
                    return new BitmapImage(new Uri("pack://application:,,,/Ecm.CustomAddin;component/Resources/Images/excel.png"));
                case "doc":
                case "docx":
                    return new BitmapImage(new Uri("pack://application:,,,/Ecm.CustomAddin;component/Resources/Images/word.png"));
                case "html":
                case "htm":
                    return new BitmapImage(new Uri("pack://application:,,,/Ecm.CustomAddin;component/Resources/Images/html.png"));
                case "pdf":
                    return new BitmapImage(new Uri("pack://application:,,,/Ecm.CustomAddin;component/Resources/Images/pdf.png"));
                case "ppt":
                case "pptx":
                    return new BitmapImage(new Uri("pack://application:,,,/Ecm.CustomAddin;component/Resources/Images/ppt.png"));
                case "xml":
                    return new BitmapImage(new Uri("pack://application:,,,/Ecm.CustomAddin;component/Resources/Images/xml.png"));
                case "xps":
                    return new BitmapImage(new Uri("pack://application:,,,/Ecm.CustomAddin;component/Resources/Images/xps.png"));
                default:
                    return new BitmapImage(new Uri("pack://application:,,,/Ecm.CustomAddin;component/Resources/Images/unknow.png"));
