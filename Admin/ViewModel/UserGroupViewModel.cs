...
namespace Ecm.Admin.ViewModel
{
    public class UserGroupViewModel : ComponentViewModel
    {
        ...
        {
            var res = new ResourceManager("Ecm.Admin.Resources", Assembly.GetExecutingAssembly());

            if (DialogService.ShowTwoStateConfirmDialog(res.GetString("uiConfirmDelete")) == DialogServiceResult.Yes)
            {
                IsProcessing = true;
