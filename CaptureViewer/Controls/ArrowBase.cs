...
namespace Ecm.CaptureViewer.Controls
{
    public abstract class ArrowBase : Shape
    {
            ...
            get
            {
                ...
                if (count > 0)
                {
                    ...
                    if ((ArrowEnds & ArrowEnds.Start) == ArrowEnds.Start)
                    {
                        ...
                        _pathgeo.Figures.Add(CalculateArrowWithLine(_pathfigHead1, pt2, pt1));
                    }
                    ...
                    if ((ArrowEnds & ArrowEnds.End) == ArrowEnds.End)
                    {
                        ...
                        _pathgeo.Figures.Add(CalculateArrowWithLine(_pathfigHead2, pt1, pt2));
                    }
                }
        ...
        private PathFigure CalculateArrowWithLine(PathFigure pathfig, Point pt1, Point pt2)
        {
            var matx = new Matrix();
            Vector vect = pt1 - pt2;
            vect.Normalize();
