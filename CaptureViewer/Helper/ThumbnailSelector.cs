    ...
    class ThumbnailSelector : BaseDependencyProperty
    {
        ...
        public void InitializeSelection()
        {
            if (ViewerContainer.Items != null)
            {
                ...
                {
                    ViewerContainer.Items.CollectionChanged += ContentItemsCollectionChanged;
                }
            }
            else
            {
        ...
        private void SetDefaultSelection()
        {
            ...
            {
                LeftMouseClick(ViewerContainer.Items[0]);
            }
            else
            {
                if (ViewerContainer.Items[0].Children.Count > 0)
                {
                    LeftMouseClick(ViewerContainer.Items[0].Children[0]);
                }
            }
        }
