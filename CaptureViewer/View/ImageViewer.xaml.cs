    ...
    public partial class ImageViewer
    {
        ...
        public void PromptOCRZone(int pageNumber, OCRTemplateZoneModel zone, OCRTemplatePageModel page)
        {
            ...
            if (CanvasItems.Count >= pageNumber)
            {
                ...
                var info = new AnnotationModel
                {
                    ...
                    CreatedOn = zone.CreatedOn.Value,
                    ModifiedBy = zone.ModifiedBy,
                    ModifiedOn = zone.ModifiedOn//zone.ModifiedOn
                };
        ...
        private void MyLayoutCanvasDoubleClickOnWorkspace(object sender, EventArgs e)
        {
            ...
            if (canvas != null && canvas.IsNonImagePreview)
            {
                ...
                ViewerContainer.ThumbnailSelector.LeftMouseClick(item);
        ...
        private byte[] GetOriginalBytes()
        {
            ...
            {
                return Items[0].Image.ImageBinary;
            }
            else
            {
                return File.ReadAllBytes(Items[0].Image.ImageFile);
            }
        }
        ...
        private void ShowHideContextMenu()
        {
            ...
            {
                mnImageZone.Visibility = Visibility.Collapsed;
                mnuPrint.Visibility = Visibility.Collapsed;
                mnuEmail.Visibility = Visibility.Collapsed;
                mnuHideAllAnnotation.Visibility = Visibility.Collapsed;
                mnuAddHighlight.Visibility = Visibility.Collapsed; ;
                mnuAddRedaction.Visibility = Visibility.Collapsed;
                mnuAddText.Visibility = Visibility.Collapsed;
                mnuSave.Visibility = Visibility.Collapsed;
                mnuAddOCRZone.Visibility = Permission.CanApplyOCRTemplate ? Visibility.Visible : Visibility.Collapsed;
            }
            else
            {
                mnuPrint.Visibility = Permission.CanPrint ? Visibility.Visible : Visibility.Collapsed;
                mnuEmail.Visibility = Permission.CanEmail ? Visibility.Visible : Visibility.Collapsed;
                mnuHideAllAnnotation.Visibility = Permission.CanHideAnnotation ? Visibility.Visible : Visibility.Collapsed;
                mnuAddHighlight.Visibility = Permission.CanAddHighlight ? Visibility.Visible : Visibility.Collapsed;
                mnuAddRedaction.Visibility = Permission.CanAddRedaction ? Visibility.Visible : Visibility.Collapsed;
                mnuAddText.Visibility = Permission.CanAddText ? Visibility.Visible : Visibility.Collapsed;
                mnuSave.Visibility = Permission.CanEmail ? Visibility.Visible : Visibility.Collapsed;
                mnuAddOCRZone.Visibility = Visibility.Collapsed;
            }
        }
    }
}
