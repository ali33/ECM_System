...
using Ecm.DocViewer.Properties;
using Ecm.Model;
using Ecm.DocViewer.Model;

namespace Ecm.DocViewer.Converter
{
    ...
    public class ShortDateTimeConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            string[] stringFormats = new[] { "d/M/yyyy", "dd/MM/yyyy", "M/d/yyyy", "MM/dd/yyyy", "yyyyMMdd", "yyyyddMM","M/dd/yyyy","MM/d/yyyy" };
            ...
            DateTime retValue = DateTime.ParseExact(date, stringFormats, culture, DateTimeStyles.AssumeUniversal);
            return retValue;
        }
    ...
    public class NullPathConverter : IValueConverter
    {
        public object Convert(object value, Type targerType, object parameter, CultureInfo culture)
        {
            if (value == null)
            {
                return new Uri("pack://application:,,,/DocViewer;component/Resources/mute.gif");
            }
    ...
    public class IndexFieldDateTimeConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            string[] format = {"M/d/yyyy h:mm:ss tt",  "yyyy-MM-dd HH:mm:ss.fff",  "yyyy-MM-dd", "d/M/yyyy", "dd/MM/yyyy", "M/d/yyyy", "MM/dd/yyyy", "yyyyMMdd", "yyyyddMM" };
