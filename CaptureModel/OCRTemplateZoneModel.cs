...
namespace Ecm.CaptureModel
{
    public class OCRTemplateZoneModel : BaseDependencyProperty
    {
        ...
        private FieldModel _fieldMetaData;
        ...
        public FieldModel FieldMetaData
        {
        ...
        {
            var newObj = (OCRTemplateZoneModel)base.OnClone();

            if (FieldMetaData != null)
            {
                newObj.FieldMetaData = (FieldModel)FieldMetaData.Clone();
            }
