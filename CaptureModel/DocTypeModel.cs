...
{
    public class DocTypeModel : BaseDependencyProperty, IDataErrorInfo
    {
        ...
        [XmlIgnore]
        public Action<DocTypeModel> ErrorChecked { get; set; }
        ...
        [XmlIgnore]
        public DocTypePermissionModel DocTypePermission { get; set; }
