namespace Ecm.CaptureModel
{
    ...
    public class Common
    {
        ...
        public const string COLUMN_PAGE_COUNT = "gvhPageCount";
        public const string COLUMN_DOCUMENT_COUNT = "gvhContentCount";
        public const string COLUMN_VERSION = "gvhVersion";
        public const string COLUMN_MODIFIED_ON = "gvhModifiedDate";
        public const string COLUMN_MODIFIED_BY = "gvhModifiedBy";
        public const string COLUMN_CREATED_ON = "gvhCreateDate";
        public const string COLUMN_CREATED_BY = "gvhCreatedBy";
        ...
        // For workflow
        public const string COLUMN_LOCKED_BY = "gvhLockedBy";
        ...
        public const string COLUMN_BLOCKING_ACTIVITY_NAME = "gvhActivityName";
        public const string COLUMN_BLOCKING_ACTIVITY_DESCRIPTION = "ActivityDescription_4E19573E_D42E_4B74_BB81_E3EF56633947";
        public const string COLUMN_BLOCKING_DATE = "gvhBlockingDate";
        public const string COLUMN_LAST_ACCESSED_DATE = "gvhLastAccessedDate";
        public const string COLUMN_LAST_ACCESSED_BY = "gvhLastAccessedBy";
        public const string COLUMN_IS_COMPLETED = "gvhCompleted";
        public const string COLUMN_IS_PROCESSING = "gvhProcessing";
        public const string COLUMN_HAS_ERROR = "gvhHasError";
        public const string COLUMN_STATUS = "gvhStatus";
        public const string COLUMN_PERMISSION = "Permission_4E19573E_D42E_4B74_BB81_E3EF56633947";
        public const string COLUMN_IS_REJECTED = "gvhIsRejected";

        //Batch status
        public const string BATCH_ERROR = "trwErrors";
        public const string BATCH_IN_PROCESSING = "trwInProcessing";
        public const string BATCH_LOCKED = "trwLockeds";
        public const string BATCH_WAITING = "trwAvailables";
        public const string BATCH_REJECTED = "trwRejected";
        ...
        public const string BATCH_DISPLAY_DOCUMENT_COUNT = "Document Count";
        ...
        public const string OUTLOOK_AUTO_SIGNIN_KEY = @"HKEY_CURRENT_USER\Software\Microsoft\Office\Outlook\Addins\OutlookCapture\AutoSignIn";
        public const string EXCEL_AUTO_SIGNIN_KEY = @"HKEY_CURRENT_USER\Software\Microsoft\Office\Excel\Addins\ExcelCapture\AutoSignIn";
        public const string WORD_AUTO_SIGNIN_KEY = @"HKEY_CURRENT_USER\Software\Microsoft\Office\Word\Addins\WordCapture\AutoSignIn";
        public const string POWER_POINT_AUTO_SIGNIN_KEY = @"HKEY_CURRENT_USER\Software\Microsoft\Office\PowerPoint\Addins\PowerPointCapture\AutoSignIn";
    }
}
