...
namespace ArchiveMVC5.Utility
{
    ...
    public class CacheHelper
    {
        ...
        private static ILog _log = LogManager.GetLogger(typeof(CacheFileResult));

        private static void ProcessException(Exception ex, string errorMessage)
        {
                            ...
                            case ContentTypeEnumeration.Image.TIFF:
                                {
                                    ...
                                    {
                                        ProcessException(ex, ex.Message);
