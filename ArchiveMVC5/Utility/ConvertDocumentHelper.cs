    ...
    public class ConvertDocumentHelper
    {
        ...
        public string PowerPoint2Html(string name, string temp)
        {
            try
            {
                ...
                PowerPoint.Presentation prsPres = ppApp.Presentations.Open(name, MsoTriState.msoTrue, MsoTriState.msoFalse, MsoTriState.msoFalse);
                //Call the SaveAs method of Presentaion object and specify the format as HTML
                prsPres.SaveAs(outName, PowerPoint.PpSaveAsFileType.ppSaveAsHTML, MsoTriState.msoTrue);
        ...
        public string PowerPoint2Pdf(string name, string temp)
        {
            try
            {
                ...
                PowerPoint.Presentation prsPres = ppApp.Presentations.Open(name, MsoTriState.msoTrue, MsoTriState.msoFalse, MsoTriState.msoFalse);
                //Call the SaveAs method of Presentaion object and specify the format as HTML
                prsPres.SaveAs(outName, PowerPoint.PpSaveAsFileType.ppSaveAsPDF, MsoTriState.msoTrue);
