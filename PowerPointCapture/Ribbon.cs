...
namespace PowerPointCapture
{
    ...
    {
        private ResourceManager _resource = new ResourceManager("PowerPointCapture.Resources", Assembly.GetExecutingAssembly());
        ...
        {
            return GetResourceText("PowerPointCapture.Ribbon.xml");
        }
