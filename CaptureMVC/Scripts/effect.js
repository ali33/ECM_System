...
var resize_vetical = function ()
	{
		...
		var captureViewer = $("div.right_column");

		//captureViewer.height(captureViewer.height() - 2);
	}
...
var resize_horizontal = function()
	{
		...
		$("div.right_column").width(window_width - left_width - menu_width - 3);
	}
...
var resize_vetical_search = function ()
	...
	var resize_vertical_between_fieldset = function (e) {
	    ...
	    $fieldset_down.height($down_height - 25);
	...
	$(".input-control > button.close").live("click", function (e) {
		e.preventDefault();
		var bt =  this;
		$(bt).parent(".input-control").find("input[type='text']").val("").trigger('input').focus();
	});
