    ...
    if (global_Page == "Capture") {
        ...
        $.each(docTypes, function (i) {
            ...
            if(per[docTypePermission.AllowedRotatePage]){
                itemsOfDocType.rotLeft = itemsOfDocTypeFull.rotLeft;
                itemsOfDocType.rotRight = itemsOfDocTypeFull.rotRight;
                itemsOfDocType.sep2 = '---';
            }
...
function createContextMenuPageClassified(docTypes, permissions) {
    ...
    if (global_Page == "Capture") {
        ...
        $.each(docTypes, function (i) {
            ...
            if(per[docTypePermission.AllowedRotatePage]){
                itemsOfPageClassified.rotLeft = itemsOfPageClassified.rotLeft;
                itemsOfPageClassified.rotRight = itemsOfPageClassified.rotRight;
