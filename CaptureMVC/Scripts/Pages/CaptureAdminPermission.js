...
$(function () {
    ...
    $(document).ready(function () {
        ...
        $("#permissions").click(function () {
            $("#nav-container").find(".nav-item ").removeClass("selected");
        ...
        $(document).on("click", "#permission_contenttype", function () {;
            ViewBy = $(this).data("value");
            ShowPermission();

        });
        $(document).on("click", "#permission_usergroup", function () {
            ViewBy = $(this).data("value");
            ShowPermission();
        ...
        $(document).on("click", ".permission_menu_item", function () {
            ...
            var $by_content_type = $(this).next().find(".sub_menu_item_by_content_type");
            if ($by_content_type.length > 0) {
                $by_content_type.first().click();
            }

            var $by_user_group = $(this).next().find(".sub_menu_item_by_user_group");
