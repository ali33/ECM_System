...
(function ($) {
    $.fn.jqte = function (options) {
        ...
        return this.each(function () {
            ...
            jQTE.html('<div class="' + vars.css + "_toolbar" + '" role="toolbar" unselectable></div><div class="' + vars.css + '_linkform" style="display:none" role="dialog"></div><div class="' + vars.css + "_editor " + vars.tagCss + '"></div>');
            ...
            function affectStyleAround(element, style) {
                ...
                if (selectedTag && style == false) {
                    console.log('selectedTag && style == false');
                    ...
                    console.log('element && style && element.is("[style]")');
