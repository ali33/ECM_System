...
(function ($) {
    $.fn.jqte = function (options) {
        ...
        return this.each(function () {
            ...
            $(this).after('<div class="' + vars.css + ' ' + vars.tagCss + '"></div>');

            // jqte
            var jQTE = $(this).next('.' + vars.css);

            // insert toolbar in jqte editor
            jQTE.html('<div class="' + vars.css + "_toolbar " + vars.tagCss + '" role="toolbar" unselectable></div><div class="' + vars.css + '_linkform" style="display:none" role="dialog"></div><div class="' + vars.css + "_editor " + vars.tagCss + '"></div>');
