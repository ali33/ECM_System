...
namespace WordCapture
{
    ...
    {
        private ResourceManager _resource = new ResourceManager("WordCapture.Resources", Assembly.GetExecutingAssembly());
        ...
        {
            return GetResourceText("WordCapture.Ribbon.xml");
        }
