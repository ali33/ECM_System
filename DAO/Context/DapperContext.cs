...
namespace Ecm.DAO.Context
{
    public class DapperContext : IDisposable
    {
        ...
        {
            //_connectionString = user.ArchiveConnectionString;
            ...
            _connectionString = ConnectionStringEncryptionHelper.GetDecryptpedConnectionString(user.ArchiveConnectionString, ENCRYPTED_KEY);
