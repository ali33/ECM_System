...
namespace Ecm.ContentViewer.Helper
{
    ...
    {
        public static void ConvertImageToPdf(List<string> pageFiles, string destFile)
        {
        ...
        public static void ConvertCanvasToPdf(List<CanvasElement> items, string destFile, WorkingFolder helper)
        {
        ...
        private static TiffBitmapEncoder Encoder(CanvasElement pageItem)
        {
