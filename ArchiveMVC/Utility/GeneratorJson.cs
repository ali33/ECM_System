            ...
            switch (field.DataType)
            {
                ...
                case Ecm.Domain.FieldDataType.Picklist:
                    switch (searchOperator)
                    {
                        case Ecm.Domain.SearchOperator.Equal:
                        case Ecm.Domain.SearchOperator.NotEqual:
                            string returnVal = @"<div class='input-control select1'><select id='value1'>{0}</select></div>";
                ...
                case Ecm.Domain.FieldDataType.Date:
                    ...
                    switch (searchOperator)
                    {
                        case Ecm.Domain.SearchOperator.InBetween:
                            return "<div class=\"input-control text date date_first\" data-date-format=\"mm-dd-yyyy\"><input id=\"value1\" type=\"text\" value=\"" + value1 + "\"></div> <span> - </span> <div class=\"input-control text date date_second\" data-date-format=\"mm-dd-yyyy\"><input id=\"value2\" type=\"text\" value=\"" + value2 + "\"></div>";
                        case Ecm.Domain.SearchOperator.Equal:
                        case Ecm.Domain.SearchOperator.NotEqual:
                        ...
                        case Ecm.Domain.SearchOperator.LessThanOrEqualTo:
                            return "<div class=\"input-control text date\" ><input  id=\"value1\" type=\"text\" value=\"" + value1 + "\"></div>";
                    }
                    break;
                ...
                case Ecm.Domain.FieldDataType.Integer:
                    ...
                    {
                        case Ecm.Domain.SearchOperator.InBetween:
                            return "<div class=\"input-control text number date_first\" ><input id=\"value1\" type=\"text\" value=\"\"></div> <span> - </span> <div class=\"input-control text number date_second\"><input id=\"value2\" type=\"text\" value=\"" + value2 + "\"></div>";
                        case Ecm.Domain.SearchOperator.Equal:
                        case Ecm.Domain.SearchOperator.NotEqual:
                        case Ecm.Domain.SearchOperator.GreaterThan:
                        case Ecm.Domain.SearchOperator.GreaterThanOrEqualTo:
                ...
                case Ecm.Domain.FieldDataType.Boolean:
                    ...
                    case Ecm.Domain.SearchOperator.Equal:
                            return "<div class=\"input-control text \" ><input id=\"value1\" type=\"text\" value=\""+value1+"\">  <button class=\"close\" tabindex=\"-1\">×</button></div>";
                        case Ecm.Domain.SearchOperator.NotEqual:
                            return "<div class=\"input-control text \" ><input id=\"value1\" type=\"text\" value=\""+value1+"\">  <button class=\"close\" tabindex=\"-1\">×</button></div></div>";
                    }
                    break;
            }
