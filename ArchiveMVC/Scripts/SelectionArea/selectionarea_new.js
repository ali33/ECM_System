...
//            $(listField).remove('option');
//            $(listField).append("<option/>");
//            $.each(list,
//            function(){
//                $(listField).append("<option>" + this + "</option>");
//            });
            arrayListField = list;
    ...
    /**********************************************************************/
    $.fn.selectionArea = function(options){
        this.each(function () {
            autoId = 0;
            if (options && options.selector)
                rs = $(options.selector).data("selectionArea", new $.selectionArea(options.area));
            else
                rs = $(this).data("selectionArea", new $.selectionArea(this));
        });
        return rs;
    };
}(jQuery));
