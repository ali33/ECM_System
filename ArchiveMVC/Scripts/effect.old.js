...
var resize_vetical = function ()
	{
		...
		$("section.body").height(window_height - header_height - border );
	}
...
var resize_vetical_search = function ()
	...
	var resize_vetical_properties_top_down_height = function (e) {
	    ...
	    var top_height = $(".sub_properties").find(".top_height").height();
	    $(".sub_properties").find(".down_height").height(sub_properties_height - top_height);
	}
	...
	var resize_vertical_multi_data = function (e) {
	    var $fieldset = $(".down_height").find(".sub_properties_mutli_data").find(".parent_fieldset");
	    var down_height = $(".down_height").height();
        //set fieldset height
	    $fieldset.height(down_height - 20);
