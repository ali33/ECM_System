...
namespace Ecm.Archive.ViewModel
{
    public class SearchExpressionViewModel : BaseDependencyProperty
    {
        ...
        {
            SearchConditions = new Dictionary<string, SearchConjunction> { { _resource.GetString("AND"), SearchConjunction.And }, { _resource.GetString("OR"), SearchConjunction.Or }, { _resource.GetString("NONE"), SearchConjunction.None} };
        ...
        private void GetSearchOperators(FieldDataType dataType)
        {
            ...
            switch (dataType)
            {
                ...
                case FieldDataType.Decimal:
                    ...
                    SearchOperators.Add(new KeyValuePair<SearchOperator,string>(SearchOperator.NotEqual, _resource.GetString("NOT_EQUAL")));
                    SearchOperators.Add(new KeyValuePair<SearchOperator,string>(SearchOperator.GreaterThan, _resource.GetString("GREATER_THAN")));
                    SearchOperators.Add(new KeyValuePair<SearchOperator,string>(SearchOperator.GreaterThanOrEqualTo, _resource.GetString("GREATER_THAN_OR_EQUAL_TO")));
                    SearchOperators.Add(new KeyValuePair<SearchOperator,string>(SearchOperator.LessThan, _resource.GetString("LESS_THAN")));
                    SearchOperators.Add(new KeyValuePair<SearchOperator,string>(SearchOperator.LessThanOrEqualTo, _resource.GetString("LESS_THAN_OR_EQUAL_TO")));
                    break;
